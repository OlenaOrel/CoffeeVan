...
import ua.treining.version_2.model.entities.coffee.Coffee;
import ua.treining.version_2.model.entities.packaging.Packaging;
...
public class CoffeeProduct {
    ...
    public CoffeeProduct(Coffee coffee, Packaging packaging, BigDecimal price) {
        ...
        this.massOfCoffee = packaging.mass();
